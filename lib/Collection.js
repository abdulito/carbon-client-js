...
Collection.prototype.insertObject = function() {
  ...
  if (_.isArray(object)) {
    throw new Error('insertObject: object cannot be an array. Use Collection.insert() instead.')
  }

  return this.endpoint.post(object, options, function(err, res) {
    try {
      cb(err, res ? res.body : undefined)
    } catch (e) {
      cb(e)
