...
CollectionCursor.prototype.eachXXX = function(cb) {
  var self = this
  function iterateNext(e, item) {
    cb(e, item)
    if( item != null ) {
      self.next(iterateNext)
    }
...
CollectionCursor.prototype._needToGetMore = function() {
  return !this.done && (this.items == null || !(this.nextItemPos in this.items))
