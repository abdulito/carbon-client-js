...
Endpoint.prototype._performOperation = function(method, operationArguments) {
  ...
  request({
    ...
    if (e) {
      ...
      cb(self.httpError(r.statusCode, r.body.message || r.body.description), r)
    } else {
      cb(null, r)
    }
  })
...
/***************************************************************************************************
 * @method _httpErrorsByCode
 * @description Attached to prototype and shared by all Endpoints
 * @returns {undefined}
 */
Endpoint.prototype._httpErrorsByCode = {}

/***************************************************************************************************
 * @method _getHttpErrorByCode
 * @description _getHttpErroByCode description
 * @param {xxx} code -- xxx
 * @returns {xxx} -- xxx
 */
