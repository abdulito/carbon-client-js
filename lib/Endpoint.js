...
/**********************************************************************
 * ALL_METHODS: list of all supported methods
 * @type {string[]}
 */
Endpoint.ALL_METHODS = [
  "get",
  "post",
  "head",
  "put",
...
Endpoint.prototype.httpError = function(code, message) {
  ...
  if (!errorClass) {
    errorClass = HttpErrors.InternalServerError
  }
...
Endpoint.prototype._applyDefaultOptions = function(options) {
  ...
  if (this.client) {
    merge(mergedOptions, this.client.defaultOptions);
  }
