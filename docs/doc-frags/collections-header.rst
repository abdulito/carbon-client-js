...
``batchSize`` is only supported with  paginated collections. Its control's pagination feature of the collection. It also can be set on the find operation level.
